...
func InviteHistoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InviteHistoryReq
		...
		l := invite.NewInviteHistoryLogic(r.Context(), svcCtx)
		resp, err := l.InviteHistory(&req)
